...
public class UserServiceListActivity extends AppCompatActivity {
    ...
    private void setViews() {
        ((LinearLayout) findViewById(R.id.layout_account_userservicelist)).setOnClickListener(v -> startActivity(new Intent(getApplicationContext(), AccountActivity.class)));
        ((LinearLayout) findViewById(R.id.layout_point_userservicelist)).setOnClickListener(v -> startActivity(new Intent(getApplicationContext(), PointActivity.class)));
        ((LinearLayout) findViewById(R.id.layout_qna_userservicelist)).setOnClickListener(v -> startActivity(new Intent(getApplicationContext(), QnAActivity.class)));
        ((LinearLayout) findViewById(R.id.layout_history_userservicelist)).setOnClickListener(v -> startActivity(new Intent(getApplicationContext(), HistoryActivity.class)));
